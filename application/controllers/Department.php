...
class Department extends CI_Controller
{
	...
	public function index()
	{
		...
		$config = array();
		//$config['base_url'] = base_url('dapartment/index');
		//$config['total_rows'] = $this->Dapartment_model->record_count($this->input->get('keyword'));
		...
		$this->load->view('department/mainpage',$data);
