			...
			<input type="hidden" value="<?php echo $doc->filename; ?>" name="datafile">
				<div class="box-body">
					...
					<div class="form-group">
						<label for="exampleInputEmail1">
							หมวดหมู่เอกสาร
						</label> <?php echo $this->session->flashdata('err_department_id'); ?>
						<select class="form-control" name="department_id">
							...
							foreach($departments as $department){
								?>
								<option value="<?php echo $department->department_id; ?>" <?php if($department->department_id==$doc->d_id){echo "selected"; } ?>>
